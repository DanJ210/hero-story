...
export interface SceneDto { id: string; sessionId: string; sequenceNumber: number; choiceText: string; narrativeText: string; imageUrl: string | null; imageUrlExpiresAt: string | null; moderationStatus: string; moderationDetail: string | null; createdAt: string; updatedAt: string; }
