        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionsRemoved = table.Column<int>(type: "int", nullable: false),
                    ScenesRemoved = table.Column<int>(type: "int", nullable: false),
                    BlobsRemoved = table.Column<int>(type: "int", nullable: false),
                    HashedIp = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeroArchetype = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    HeroName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ModerationFailureCount = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StorySessions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NarrativeText = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImageUrlExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModerationStatus = table.Column<int>(type: "int", nullable: false),
                    ModerationDetail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Scenes_StorySessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GenerationJobs_Scenes_SceneId",
                        column: x => x.SceneId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StorySessions_UserId_CreatedAt",
                table: "StorySessions",
